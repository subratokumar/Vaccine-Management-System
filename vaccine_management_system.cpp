...
void vaccine::search_data()
{
    ...
    cout<<"\n\t\t 1. By Vaccine Name \t\t\t 2. By Age "<<endl;
...
void vaccine::search_by_vaccinename()
{
    ...
    cout<<"\n\t\t\t*****************************************\n\n";
    cout<<"Enter Vaccine name by which you want to search "<<endl;
    fflush(stdin);
    getline(cin,prof);
    show();
    ...
    while(!in.eof())
    {
        if(prof.compare(vaccine_name)==0)
        {
            show_list();
            flag=1;
            p++;
    ...
    if(flag==0)
    {
    cout<<"The VAccine you have Enter does not exist"<<endl;
    }
    cout<<"\n\n\n NO of people vaccinated by this vaccine name "<<p<<endl;
    in.close();
}
...
void vaccine::setdata()
{
    ...
    fflush(stdin);
        ...
        cout<<"\n\t\t Enter Vaccine Name Which is to be given :- ";
